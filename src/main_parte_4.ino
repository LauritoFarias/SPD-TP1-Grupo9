...
void loop()
{
  ...
  if (estadoSwitchIngreso == HIGH) {
    ...
    if (estadoSwitchNumeros == HIGH){
      ...
      /**
      Esto corresponderia a los numeros primos:
    ...
    */
      ...
      /*
      Cuando se presionan los botones de suma o resta, el
      programa aumenta o disminuye el numero en 5. Si el numero
      es sobrepasa el 99 o llega a ser menor a 0, el contador
      vuelve a 0 o a 95 respectivamente.
      */
      
      if (deteccionSuma.ejecucion){
        numeroMultiploDe5 += 5;
        if (numeroMultiploDe5 > 99) {
          numeroMultiploDe5 = 0;
        }
      }
      if (deteccionResta.ejecucion){
        numeroMultiploDe5 -= 5;
        if (numeroMultiploDe5 < 0) {
          numeroMultiploDe5 = 95;
        }
      }
      if (deteccionReset.ejecucion){
        numeroMultiploDe5 = 0;
      }
      numero = numeroMultiploDe5;
      Serial.print("Multiplo de 5: ");
